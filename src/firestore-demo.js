...
export class FirestoreDemo extends LitElement {
  ...
  constructor() {
    ...
    //conexion a la base de datos de firestore
    this.db = dbFirestore;
    // this.getUsers();
  }
  ...
  render() {
    ...
    <!--Cada vez que se actualiza el template actualiza los usuarios y los guarda-->
  ...
  //coge el usuario mediante su id
  userInsert( e ) {
